...
C {schematics/add/AND.sym} 40 -60 0 0 {name=x1}
C {schematics/add/XOR.sym} 40 -180 0 0 {name=x2}
C {schematics/add/OR.sym} 70 70 0 0 {name=x3}
...
C {schematics/add/XOR.sym} 40 210 0 0 {name=x4}
...
C {schematics/add/MUX41.sym} 560 0 0 0 {name=x5}
...
C {schematics/add/AND.sym} 410 260 0 0 {name=x6}
C {schematics/add/OR.sym} 660 280 0 0 {name=x7}
